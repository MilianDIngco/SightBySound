...
Useful tools: 
- https://github.com/MilianDIngco/find-cam
  - Used to find the dynamic links to each respective camera.
- https://github.com/MilianDIngco/StereoBM-Calibrator
  - Used to generate the .yml configuration files for the cameras.
  - Requires a checkerboard pattern to calibrate the cameras.  
...
|
├── 📂 settings/                   # Contains files for camera calibration and other settings
|   ├── 📄 _.yml                    # Camera configuration files
|   ├── 📄 laptop_settings.txt      # Configurable runtime settings 
│
